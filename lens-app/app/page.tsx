...
export default function Home() {
  ...
  const [profileHandle, setProfileHandle] = useState({} as any);
  ...
  return (
    ...
    >
      {/* profile modal here */}
      <ProfileModal profileHandle={profileHandle.fullHandle} />
      ...
      <div>
        ...
        <h1 className="text-5xl font-bold mt-3">Social Explorer</h1>
